...
class TestDAGWithBackend:
    ...
    def test_dag_backend_caching(self):
        ...
        pd.testing.assert_frame_equal(first_results['csv_node'], second_results['csv_node'])
        pd.testing.assert_frame_equal(first_results['operation_node'], second_results['operation_node'])
